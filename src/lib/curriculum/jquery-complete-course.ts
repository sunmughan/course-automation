  ...
  "modules": [
    {
      ...
      "description": "Comprehensive coverage of chapters 1 to 10 in jQuery & Legacy DOM Architecture.",
      "slug": "jquery-legacy-dom-architecture-phase-1",
      "topics": [
        {
          "title": "Chapter 1: Getting started with jQuery",
          "description": "Comprehensive guide to Chapter 1: Getting started with jQuery with real code examples and step-by-step execution flow.",
          "slug": "ch-1-getting-started-with-jquery",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Getting Started",
              "description": "Practical application of Getting Started in Getting started with jQuery with standard industry patterns."
            },
            {
              "title": "Avoiding namespace collisions",
              "description": "Practical application of Avoiding namespace collisions in Getting started with jQuery with standard industry patterns."
            },
            {
              "title": "jQuery Namespace (\"jQuery\" and \"$\")",
              "description": "Practical application of jQuery Namespace (\"jQuery\" and \"$\") in Getting started with jQuery with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "Getting started with jQuery Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 2: Selectors with real code examples and step-by-step execution flow.",
          "slug": "ch-2-selectors",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Overview",
              "description": "Practical application of Overview in Selectors with standard industry patterns."
            },
            {
              "title": "Types of Selectors",
              "description": "Practical application of Types of Selectors in Selectors with standard industry patterns."
            },
            {
              "title": "Caching Selectors",
              "description": "Practical application of Caching Selectors in Selectors with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 3: Each function with real code examples and step-by-step execution flow.",
          "slug": "ch-3-each-function",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "jQuery each function",
              "description": "Practical application of jQuery each function in Each function with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 4: Attributes with real code examples and step-by-step execution flow.",
          "slug": "ch-4-attributes",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Di\ue023erece between attr() and prop()",
              "description": "Practical application of Di\ue023erece between attr() and prop() in Attributes with standard industry patterns."
            },
            {
              "title": "Get the attribute value of a HTML element",
              "description": "Practical application of Get the attribute value of a HTML element in Attributes with standard industry patterns."
            },
            {
              "title": "Setting value of HTML attribute",
              "description": "Practical application of Setting value of HTML attribute in Attributes with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 5: document: ready event with real code examples and step-by-step execution flow.",
          "slug": "ch-5-document-ready-event",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "What is document: ready and how should I use it?",
              "description": "Practical application of What is document: ready and how should I use it? in document: ready event with standard industry patterns."
            },
            {
              "title": "jQuery 2.2.3 and earlier",
              "description": "Practical application of jQuery 2.2.3 and earlier in document: ready event with standard industry patterns."
            },
            {
              "title": "jQuery 3.0",
              "description": "Practical application of jQuery 3.0 in document: ready event with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "document: ready event Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 6: Events with real code examples and step-by-step execution flow.",
          "slug": "ch-6-events",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              ...
              "description": "Practical application of Delegated Events in Events with standard industry patterns."
            },
            {
              "title": "Attach and Detach Event Handlers",
              "description": "Practical application of Attach and Detach Event Handlers in Events with standard industry patterns."
            },
            {
              "title": "Switching speci\ufb01c events on and o\ue023 via jQuery. (Named Listeners)",
              "description": "Practical application of Switching speci\ufb01c events on and o\ue023 via jQuery. (Named Listeners) in Events with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 7: DOM Manipulation with real code examples and step-by-step execution flow.",
          "slug": "ch-7-dom-manipulation",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Creating DOM elements",
              "description": "Practical application of Creating DOM elements in DOM Manipulation with standard industry patterns."
            },
            {
              "title": "Manipulating element classes",
              "description": "Practical application of Manipulating element classes in DOM Manipulation with standard industry patterns."
            },
            {
              "title": "Other API Methods",
              "description": "Practical application of Other API Methods in DOM Manipulation with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 8: DOM Traversing with real code examples and step-by-step execution flow.",
          "slug": "ch-8-dom-traversing",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Select children of element",
              "description": "Practical application of Select children of element in DOM Traversing with standard industry patterns."
            },
            {
              "title": "Get next element",
              "description": "Practical application of Get next element in DOM Traversing with standard industry patterns."
            },
            {
              "title": "Get previous element",
              "description": "Practical application of Get previous element in DOM Traversing with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 9: CSS Manipulation with real code examples and step-by-step execution flow.",
          "slug": "ch-9-css-manipulation",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "CSS: Getters and Setters",
              "description": "Practical application of CSS: Getters and Setters in CSS Manipulation with standard industry patterns."
            },
            {
              "title": "Increment/Decrement Numeric Properties",
              "description": "Practical application of Increment/Decrement Numeric Properties in CSS Manipulation with standard industry patterns."
            },
            {
              "title": "Set CSS property",
              "description": "Practical application of Set CSS property in CSS Manipulation with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 10: Element Visibility with real code examples and step-by-step execution flow.",
          "slug": "ch-10-element-visibility",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Overview",
              "description": "Practical application of Overview in Element Visibility with standard industry patterns."
            },
            {
              "title": "Toggle possibilities",
              "description": "Practical application of Toggle possibilities in Element Visibility with standard industry patterns."
            }
          ],
          "examples": [
            {
    ...
    },
    {
      ...
      "description": "Comprehensive coverage of chapters 11 to 20 in jQuery & Legacy DOM Architecture.",
      "slug": "jquery-legacy-dom-architecture-phase-2",
      "topics": [
        {
          "title": "Chapter 11: Append",
          "description": "Comprehensive guide to Chapter 11: Append with real code examples and step-by-step execution flow.",
          "slug": "ch-11-append",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "E\ue024cient consecutive .append() usage",
              "description": "Practical application of E\ue024cient consecutive .append() usage in Append with standard industry patterns."
            },
            {
              "title": "jQuery append",
              "description": "Practical application of jQuery append in Append with standard industry patterns."
            },
            {
              "title": "Appending an element to a container",
              "description": "Practical application of Appending an element to a container in Append with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 12: Prepend with real code examples and step-by-step execution flow.",
          "slug": "ch-12-prepend",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Prepending an element to a container",
              "description": "Practical application of Prepending an element to a container in Prepend with standard industry patterns."
            },
            {
              "title": "Prepend method",
              "description": "Practical application of Prepend method in Prepend with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 13: Getting and setting width and height of an element with real code examples and step-by-step execution flow.",
          "slug": "ch-13-getting-and-setting-width-and-height-of-an-element",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Getting and setting width and height (ignoring border)",
              "description": "Practical application of Getting and setting width and height (ignoring border) in Getting and setting width and height of an element with standard industry patterns."
            },
            {
              "title": "Getting and setting innerWidth and innerHeight (ignoring padding and border)",
              "description": "Practical application of Getting and setting innerWidth and innerHeight (ignoring padding and border) in Getting and setting width and height of an element with standard industry patterns."
            },
            {
              "title": "Getting and setting outerWidth and outerHeight (including padding and border)",
              "description": "Practical application of Getting and setting outerWidth and outerHeight (including padding and border) in Getting and setting width and height of an element with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "Getting and setting width and height of an element Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 14: jQuery .animate() Method with real code examples and step-by-step execution flow.",
          "slug": "ch-14-jquery-animate-method",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Animation with callback",
              "description": "Practical application of Animation with callback in jQuery .animate() Method with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "jQuery .animate() Method Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 15: jQuery Deferred objects and Promises with real code examples and step-by-step execution flow.",
          "slug": "ch-15-jquery-deferred-objects-and-promises",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "jQuery ajax() success, error VS .done(), .fail()",
              "description": "Practical application of jQuery ajax() success, error VS .done(), .fail() in jQuery Deferred objects and Promises with standard industry patterns."
            },
            {
              "title": "Basic promise creation",
              "description": "Practical application of Basic promise creation in jQuery Deferred objects and Promises with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "jQuery Deferred objects and Promises Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 16: Ajax with real code examples and step-by-step execution flow.",
          "slug": "ch-16-ajax",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Handling HTTP Response Codes with $.ajax()",
              "description": "Practical application of Handling HTTP Response Codes with $.ajax() in Ajax with standard industry patterns."
            },
            {
              "title": "Using Ajax to Submit a Form",
              "description": "Practical application of Using Ajax to Submit a Form in Ajax with standard industry patterns."
            },
            {
              "title": "All in one examples",
              "description": "Practical application of All in one examples in Ajax with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 17: Checkbox Select all with automatic check/uncheck on other checkbox change with real code examples and step-by-step execution flow.",
          "slug": "ch-17-checkbox-select-all-with-automatic-check-uncheck-on-ot",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "2 select all checkboxes with corresponding group checkboxes",
              "description": "Practical application of 2 select all checkboxes with corresponding group checkboxes in Checkbox Select all with automatic check/uncheck on other checkbox change with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "Checkbox Select all with automatic check/uncheck on other checkbox change Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 18: Plugins with real code examples and step-by-step execution flow.",
          "slug": "ch-18-plugins",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Plugins: Getting Started",
              "description": "Practical application of Plugins: Getting Started in Plugins with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 19: Credits with real code examples and step-by-step execution flow.",
          "slug": "ch-19-credits",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 20: You may also like with real code examples and step-by-step execution flow.",
          "slug": "ch-20-you-may-also-like",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
