  ...
  "modules": [
    {
      ...
      "description": "Comprehensive coverage of chapters 1 to 10 in MongoDB NoSQL Architecture (25 Chapters).",
      "slug": "mongodb-nosql-architecture-25-chapters-phase-1",
      "topics": [
        {
          "title": "Chapter 1: Getting started with MongoDB",
          "description": "Comprehensive guide to Chapter 1: Getting started with MongoDB with real code examples and step-by-step execution flow.",
          "slug": "ch-1-getting-started-with-mongodb",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 2: CRUD Operation with real code examples and step-by-step execution flow.",
          "slug": "ch-2-crud-operation",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 3: Getting database information with real code examples and step-by-step execution flow.",
          "slug": "ch-3-getting-database-information",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 4: Querying for Data (Getting Started) with real code examples and step-by-step execution flow.",
          "slug": "ch-4-querying-for-data-getting-started",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 5: Update Operators with real code examples and step-by-step execution flow.",
          "slug": "ch-5-update-operators",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 6: Upserts and Inserts with real code examples and step-by-step execution flow.",
          "slug": "ch-6-upserts-and-inserts",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 7: Collections with real code examples and step-by-step execution flow.",
          "slug": "ch-7-collections",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 8: Aggregation with real code examples and step-by-step execution flow.",
          "slug": "ch-8-aggregation",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 9: Indexes with real code examples and step-by-step execution flow.",
          "slug": "ch-9-indexes",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 10: Bulk Operations with real code examples and step-by-step execution flow.",
          "slug": "ch-10-bulk-operations",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
    ...
    },
    {
      ...
      "description": "Comprehensive coverage of chapters 11 to 20 in MongoDB NoSQL Architecture (25 Chapters).",
      "slug": "mongodb-nosql-architecture-25-chapters-phase-2",
      "topics": [
        {
          "title": "Chapter 11: 2dsphere Index",
          "description": "Comprehensive guide to Chapter 11: 2dsphere Index with real code examples and step-by-step execution flow.",
          "slug": "ch-11-2dsphere-index",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 12: Pluggable Storage Engines with real code examples and step-by-step execution flow.",
          "slug": "ch-12-pluggable-storage-engines",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 13: Java Driver with real code examples and step-by-step execution flow.",
          "slug": "ch-13-java-driver",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Fetch Collection data with condition",
              "description": "Practical application of Fetch Collection data with condition in Java Driver with standard industry patterns."
            },
            {
              "title": "Create a database user",
              "description": "Practical application of Create a database user in Java Driver with standard industry patterns."
            },
            {
              "title": "Create a tailable cursor",
              "description": "Practical application of Create a tailable cursor in Java Driver with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 14: Python Driver with real code examples and step-by-step execution flow.",
          "slug": "ch-14-python-driver",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Connect to MongoDB using pymongo",
              "description": "Practical application of Connect to MongoDB using pymongo in Python Driver with standard industry patterns."
            },
            {
              "title": "PyMongo queries",
              "description": "Practical application of PyMongo queries in Python Driver with standard industry patterns."
            },
            {
              "title": "Update all documents in a collection using PyMongo",
              "description": "Practical application of Update all documents in a collection using PyMongo in Python Driver with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 15: Mongo as Shards with real code examples and step-by-step execution flow.",
          "slug": "ch-15-mongo-as-shards",
          "difficulty": 2,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Sharding Environment Setup",
              "description": "Practical application of Sharding Environment Setup in Mongo as Shards with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 16: Replication with real code examples and step-by-step execution flow.",
          "slug": "ch-16-replication",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Basic con\ufb01guration with three nodes",
              "description": "Practical application of Basic con\ufb01guration with three nodes in Replication with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 17: Mongo as a Replica Set with real code examples and step-by-step execution flow.",
          "slug": "ch-17-mongo-as-a-replica-set",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Mongodb as a Replica Set",
              "description": "Practical application of Mongodb as a Replica Set in Mongo as a Replica Set with standard industry patterns."
            },
            {
              "title": "Check MongoDB Replica Set states",
              "description": "Practical application of Check MongoDB Replica Set states in Mongo as a Replica Set with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "Mongo as a Replica Set Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 18: MongoDB: Con\ufb01gure a ReplicaSet to support TLS/SSL with real code examples and step-by-step execution flow.",
          "slug": "ch-18-mongodb-con-gure-a-replicaset-to-support-tls-ssl",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "How to con\ufb01gure a ReplicaSet to support TLS/SSL?",
              "description": "Practical application of How to con\ufb01gure a ReplicaSet to support TLS/SSL? in MongoDB: Con\ufb01gure a ReplicaSet to support TLS/SSL with standard industry patterns."
            },
            {
              "title": "How to connect your Client (Mongo Shell) to a ReplicaSet?",
              "description": "Practical application of How to connect your Client (Mongo Shell) to a ReplicaSet? in MongoDB: Con\ufb01gure a ReplicaSet to support TLS/SSL with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "MongoDB: Con\ufb01gure a ReplicaSet to support TLS/SSL Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 19: Authentication Mechanisms in MongoDB with real code examples and step-by-step execution flow.",
          "slug": "ch-19-authentication-mechanisms-in-mongodb",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Authentication Mechanisms",
              "description": "Practical application of Authentication Mechanisms in Authentication Mechanisms in MongoDB with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "Authentication Mechanisms in MongoDB Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 20: MongoDB Authorization Model with real code examples and step-by-step execution flow.",
          "slug": "ch-20-mongodb-authorization-model",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Build: in Roles",
              "description": "Practical application of Build: in Roles in MongoDB Authorization Model with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "MongoDB Authorization Model Flow",
              "config": "{}"
            }
          ],
          "lesson": {
    ...
    {
      "title": "Phase 3: Chapters 21 to 25",
      "description": "Comprehensive coverage of chapters 21 to 25 in MongoDB NoSQL Architecture (25 Chapters).",
      "slug": "mongodb-nosql-architecture-25-chapters-phase-3",
      "topics": [
        {
          "title": "Chapter 21: Con\ufb01guration",
          "description": "Comprehensive guide to Chapter 21: Con\ufb01guration with real code examples and step-by-step execution flow.",
          "slug": "ch-21-con-guration",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Starting mongo with a speci\ufb01c con\ufb01g \ufb01le",
              "description": "Practical application of Starting mongo with a speci\ufb01c con\ufb01g \ufb01le in Con\ufb01guration with standard industry patterns."
            }
          ],
          "examples": [
            {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 22: Backing up and Restoring Data with real code examples and step-by-step execution flow.",
          "slug": "ch-22-backing-up-and-restoring-data",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Basic mongodump of local default mongod instance",
              "description": "Practical application of Basic mongodump of local default mongod instance in Backing up and Restoring Data with standard industry patterns."
            },
            {
              "title": "Basic mongorestore of local default mongod dump",
              "description": "Practical application of Basic mongorestore of local default mongod dump in Backing up and Restoring Data with standard industry patterns."
            },
            {
              "title": "mongoimport with JSON",
              "description": "Practical application of mongoimport with JSON in Backing up and Restoring Data with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "Backing up and Restoring Data Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 23: Upgrading MongoDB version with real code examples and step-by-step execution flow.",
          "slug": "ch-23-upgrading-mongodb-version",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
              "title": "Upgrading to 3.4 on Ubuntu 16.04 using apt",
              "description": "Practical application of Upgrading to 3.4 on Ubuntu 16.04 using apt in Upgrading MongoDB version with standard industry patterns."
            }
          ],
          "examples": [
            {
          ...
          "visualizations": [
            {
              "type": "flow-animation",
              "title": "Upgrading MongoDB version Flow",
              "config": "{}"
            }
          ],
          "lesson": {
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 24: Credits with real code examples and step-by-step execution flow.",
          "slug": "ch-24-credits",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
        ...
        },
        {
          ...
          "description": "Comprehensive guide to Chapter 25: You may also like with real code examples and step-by-step execution flow.",
          "slug": "ch-25-you-may-also-like",
          "difficulty": 3,
          "prerequisites": [],
          "concepts": [
            {
